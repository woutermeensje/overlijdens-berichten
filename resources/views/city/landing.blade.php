            ...
            <div class="card-body py-4 gap-3">
                <div class="flex items-start gap-3">
                    ...
                    <div class="flex-1 min-w-0">
                        <p class="font-semibold text-base">Ontvang wekelijks de laatste overlijdensberichten uit {{ $cityName }}</p>
                ...
                <form method="POST" action="{{ route('newsletter.subscribe') }}" class="flex flex-col sm:flex-row gap-2">
                    ...
                    <input type="text" name="region" value="{{ $cityName }}" placeholder="Stad of plaats" class="input input-bordered flex-1 w-full" />
